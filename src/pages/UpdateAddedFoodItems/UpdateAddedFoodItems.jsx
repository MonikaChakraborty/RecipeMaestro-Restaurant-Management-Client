...
const UpdateAddedFoodItems = () => {
    ...
    return (
      ...
      <h1 className="text-4xl text-center mb-6 font-bold">Update Food Item: {foodName}</h1>
      ...
      <form onSubmit={handleUpdateFoodItem} className="space-y-5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="form-control">
            ...
            <input
              ...
              name="foodName"   defaultValue={foodName}
            />
          </div>
          ...
          <div className="form-control">
            ...
            <input
              ...
              className="input input-bordered"
              name="foodImage" defaultValue={foodImage}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="form-control">
            ...
            <input
              ...
              className="input input-bordered"
              name="foodOrigin" defaultValue={foodOrigin}
            />
          </div>
          ...
          <div className="form-control">
            ...
            <input
              ...
              className="input input-bordered"
              name="foodCategory" defaultValue={foodCategory}
            />
          </div>
        </div>
        ...
        <button className="btn bg-yellow-800 text-white hover:bg-yellow-900" type="submit">
          Update
        </button>
      </form>
    </div>
