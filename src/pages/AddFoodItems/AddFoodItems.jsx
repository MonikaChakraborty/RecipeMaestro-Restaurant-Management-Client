...
const AddFoodItems = () => {
  ...
  const handleAddFoodItem = event => {
    ...
    // send to server
    fetch('https://restaurant-management-system-server-kappa.vercel.app/addFoodItems', {
      method: 'POST',
      headers: {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 p-8 bg-gray-100 rounded shadow-lg">
      <h1 className="text-4xl text-center mb-6 font-bold">Add a Food Item</h1>
      ...
      <form onSubmit={handleAddFoodItem} className="space-y-5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="form-control">
            ...
            <input
              type="text"
              placeholder="Food Image" required
              className="input input-bordered"
              name="foodImage"
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="form-control">
            ...
            <input
              type="text"
              placeholder="Food Origin" required
              className="input input-bordered"
              name="foodOrigin"
            />
          </div>
